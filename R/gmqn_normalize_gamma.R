...
gmqn_normalize_gamma <- function(m, um, probe, type = '450k', ref) {
  ...
  sub.pro = cbind(dgamma(t1.red.signal, t1.red.alpha[1], 1/t1.red.beta[1]),
                  dgamma(t1.red.signal, t1.red.alpha[2], 1/t1.red.beta[2]))
  ...
  sub.pro = cbind(dgamma(t1.green.signal, t1.green.alpha[1], 1/t1.green.beta[1]),
                  dgamma(t1.green.signal, t1.green.alpha[2], 1/t1.green.beta[2]))
  subsetclass <- apply(sub.pro, 1, which.max)
