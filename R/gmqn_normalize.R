...
gmqn_normalize <- function(m, um, probe, type = '450k', ref = 'default', verbose = TRUE) {
  ...
  t1.green.signal[which(t1.green.model$classification == 1 & pnorm(t1.green.signal, t1.green.mean[1], t1.green.sd[1]) < 0.95 & pnorm(t1.green.signal, t1.green.mean[1], t1.green.sd[1]) > 0.05)] <- qnorm(pnorm(t1.green.signal[which(t1.green.model$classification == 1 & pnorm(t1.green.signal, t1.green.mean[1], t1.green.sd[1]) < 0.95 & pnorm(t1.green.signal, t1.green.mean[1], t1.green.sd[1]) > 0.05)],t1.green.mean[1], t1.green.sd[1]), ref$t1.green.ref.mean[1], ref$t1.green.ref.sd[1])
